...
# Load adapter
adapter_model = PeftModel.from_pretrained(base_model, guanaco7b)
...
# Initialize the defended model
    ...
    parser = argparse.ArgumentParser(
        description='Script to interact with AI models',
    ...
    isPassed, ppl = defended_model.is_sequence_safe(prompt)
    print(f"== Result:{isPassed}\n\n")
    print(f"PPL:{ppl}\n\n ==")

    print(f"RESPOND: \n{defended_model.generate_safe_response(prompt,max_new_tokens=max_tokens)}")
